...
class Program
    {
        ...
        public void ReadTextFiles()
        {
            ...
            using (StreamReader file = new StreamReader("U:/Users/731847/Assignment#4/Beowulf.txt"))
            {
                int counter = 0;
                string ln;
        ...
        {
            long lineCounter = 0;
            using (StreamReader fil = new StreamReader("U:/Users/731847/Assignment#4/Beowulf.txt"))
            {
        ...
        {
            StreamReader reader = new StreamReader("U:/Users/731847/Assignment#4/Beowulf.txt");
        ...
        public void Letters()
        {
            ...
            while (index < text.Length)
            {
                //  to check whether current char is part of a word
                while (index < text.Length && !char.IsWhiteSpace(text[index]))
                    index++;
                wordCount++;
                // skip whitespace until next word comes
                while (index < text.Length && char.IsWhiteSpace(text[index]))
                    index++;
            }
            //find average
